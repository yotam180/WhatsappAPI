(function() {
	...
	function showControlMessage() {
		...
		setTimeout(() => { 
			m.children[1].innerHTML = "<br/><br/><br/><br/><div style='margin: auto; width: 80%; padding: 30px; border-radius: 5px; background-color: white;'>WhatsApp is being controlled by WhatsBot&trade;<br/><br/><a id='cancel_bot' href='#'>Stop bot action</a></div>"; 
